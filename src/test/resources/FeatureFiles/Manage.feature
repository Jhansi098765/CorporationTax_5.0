...
Background: User login
  ...
  And   Enter name in first name textfield
  And   Enter mail in email textfield
  ...
  And   Click on export to CSV
   ...
   Scenario: Verify delete yes option functionality in add users tab
   Given Click on ManageDashboard
   When  Click on users option
   And   Click on Adduser
   Then  Click on UserCheckbox
   ...
   Scenario: Verify delete No option functionality in add users tab
   Given Click on ManageDashboard
   When  Click on users option
   And   Click on Adduser
   Then  Click on UserCheckbox
   ...
   Scenario: creating a new user and save
   Given Click on ManageDashboard
   When  Click on users option
   And   Click on Adduser
   And   Enter name in Firstname textfield  
   And   Enter mail in Gmail textfield
   And   Click on Save
  ...
  Scenario: Verify ExportAsPDF option functionality in add users tab
   ...
   Scenario: Verify delete Yes option functionality in Users tab
   Given Click on ManageDashboard
   When  Click on users option
   Then  Click on UserCheckboxInUsersTab
   And   Click on deleteInUsers button
   And   Click on YesInUsers Button
   
   Scenario: Verify delete No option functionality in Users tab
   Given Click on ManageDashboard
   When  Click on users option
   Then  Click on UserCheckboxInUsersTab
   And   Click on deleteInUsers button
   And   Click on NoInUsers button
   ...
   Scenario: Create a administrator in Users with  fields 
   Given Click on ManageDashboard
   When  Click on users option
   And   Click on Adduser
   Then enter all details 
   
  Scenario: Verify This day dropdown
  //Given Click on ManageDashboard
